...
\begin{figure}[h]
	...
	\caption{A screenshot of a slightly modified StepMania in-song interface, with the player having recently scored a ``perfect'' (the second best judgment in unmodified StepMania). The song is Super Trouper by A-Teens. Image courtesy of Oddweb.}
	\label{img-smgp}
\end{figure}
