...
\begin{figure}[h]
	\centering
	\includegraphics[width=2in]{{images/sm2.jpg}}
	\caption{A screenshot of a the StepMania in-song interface, with the player missing a step. The song is Super Trouper by A-Teens Image courtesy of Oddweb.}
	\label{img-smgp}
\end{figure}